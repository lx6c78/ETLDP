...
import models_etldp as models_etldp
...
def main(args):
    ...
    model = models_etldp.__dict__[args.model](
    ...
    best_checkpoint = torch.load(os.path.join("/root/autodl-tmp/NetMambavision/new_etldp_weights_and.pth"), map_location='cpu')
