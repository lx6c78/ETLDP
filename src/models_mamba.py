...
class Block(nn.Module):
    ...
    def forward(self, hidden_states: Tensor, residual: Optional[Tensor] = None, inference_params=None, extra_emb=None):
        ...
        hidden_states = self.mixer(hidden_states, inference_params=inference_params, extra_emb=extra_emb)
